...
public class IdentityHubCredentialsVerifier implements CredentialsVerifier {
    ...
    private final VerifiableCredentialsJwtUnmarshaller verifiableCredentialsJwtUnmarshaller;
     ...
     */
    public IdentityHubCredentialsVerifier(IdentityHubClient identityHubClient, Monitor monitor, JwtCredentialsVerifier jwtCredentialsVerifier, VerifiableCredentialsJwtUnmarshaller verifiableCredentialsJwtUnmarshaller) {
        this.identityHubClient = identityHubClient;
        this.monitor = monitor;
        this.jwtCredentialsVerifier = jwtCredentialsVerifier;
        this.verifiableCredentialsJwtUnmarshaller = verifiableCredentialsJwtUnmarshaller;
    }
    ...
    public Result<Map<String, Object>> getVerifiedCredentials(DidDocument didDocument) {
        ...
        var partitionedResult = verifiedJwt.map(verifiableCredentialsJwtUnmarshaller::extractCredential).collect(partitioningBy(AbstractResult::succeeded));
