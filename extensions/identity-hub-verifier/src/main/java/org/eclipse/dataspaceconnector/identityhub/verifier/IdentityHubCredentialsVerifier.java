...
public class IdentityHubCredentialsVerifier implements CredentialsVerifier {
    ...
    private final VerifiableCredentialsJwtMapper verifiableCredentialsJwtMapper;
     ...
     */
    public IdentityHubCredentialsVerifier(IdentityHubClient identityHubClient, Monitor monitor, JwtCredentialsVerifier jwtCredentialsVerifier, VerifiableCredentialsJwtMapper verifiableCredentialsJwtMapper) {
        this.identityHubClient = identityHubClient;
        this.monitor = monitor;
        this.jwtCredentialsVerifier = jwtCredentialsVerifier;
        this.verifiableCredentialsJwtMapper = verifiableCredentialsJwtMapper;
    }
    ...
    public Result<Map<String, Object>> getVerifiedCredentials(DidDocument didDocument) {
        ...
        var partitionedResult = verifiedJwt.map(verifiableCredentialsJwtMapper::extractCredential).collect(partitioningBy(AbstractResult::succeeded));
